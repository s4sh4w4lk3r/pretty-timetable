...
export type ActualTimetablesQuery = { __typename?: 'Query', actualTimetables: Array<{ __typename?: 'ActualTimetable', weekNumber: number, group: { __typename?: 'Group', id: number, name: string }, cards?: Array<{ __typename?: 'ActualCard', lessonTimeId: number, date: any, isModified: boolean, isCanceled: boolean, isMoved: boolean, subGroup: SubGroup, cabinet: { __typename?: 'Cabinet', id: number, fullName: string }, teacher: { __typename?: 'Teacher', id: number, firstname: string, lastname: string }, subject: { __typename?: 'Subject', name: string, id: number } }> | null }> };
