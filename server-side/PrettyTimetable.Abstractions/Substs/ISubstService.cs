...
namespace PrettyTimetable.Abstractions.Substs
{
    public interface ISubstService
    {
        Task<ServiceResult<int>> PutAsync(Core.Entities.Substs.Substitution substitution, CancellationToken cancellationToken = default);
        ...
        async Task<ServiceResult> PutAndNotifyAsync(Core.Entities.Substs.Substitution substitution, CancellationToken cancellationToken = default)
        {
